...
ready: true
assigned: 2019-04-22 17:00
due: 2019-04-29 17:00
---

*Reading Assignment:* 

* Read [HFJ Chapter 7](http://ucsb-cs56-pconrad.github.io/hfj/HFJ_Chapter_7/) and [HFJ Chapter 8](http://ucsb-cs56-pconrad.github.io/hfj/HFJ_Chapter_8/), along with the online reading notes that go with those chapters. Then, do the problems below. Refer back to previous chapters as needed.
...
<li>
(10 pts)  Based on your reading in [HFJ Chapter 7](http://ucsb-cs56-pconrad.github.io/hfj/HFJ_Chapter_7/), complete the following exercise from p. 179, putting a check next to the relationships that make sense.
...
(10 pts)  Based on your reading in [HFJ Chapter 7](http://ucsb-cs56-pconrad.github.io/hfj/HFJ_Chapter_7/):
...
(10 pts)  Based on your reading in [HFJ Chapter 8](http://ucsb-cs56-pconrad.github.io/hfj/HFJ_Chapter_8/):
...
There is a passage in HFJ Chapter 7 that helps to explain the difference.
...
<li>
There is a passage in HFJ Chapter 7 that helps to explain the difference between IS-A and HAS-A:
